  ...
  return (
    <>
      <div 
        ...
        className={`group relative bg-[#1A1A1E] border border-white/[0.05] rounded-2xl overflow-hidden hover:bg-[#232329] transition-all duration-300 shadow-sm hover:shadow-[0_8px_30px_rgba(0,0,0,0.5)] active:scale-[0.98] cursor-pointer ${className}`}
      >
