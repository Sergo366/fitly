...
export default function WardrobePage() {
  ...
  if (selectedCategory) {
    const items = groupedClothes[selectedCategory] || [];
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        >
          ...
          <span className="font-semibold tracking-tight cursor-pointer">Back to Wardrobe</span>
        </button>
        ...
        <div className="flex items-baseline justify-between mb-12">
          <div>
            ...
            <p className="text-stone-500 mt-2 font-medium">
              {items.length} {items.length === 1 ? 'essential item' : 'curated items'} in your
              collection
            </p>
          </div>
        </div>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
      ...
      <header className="mb-16 relative pt-4">
